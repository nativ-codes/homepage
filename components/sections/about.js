		...
		<section className="about-section flex lg:h-screen flex-col lg:flex-row">
			...
			<div className="about-section-right relative bg-white p-[56px] lg:p-[96px] w-full h-screen lg:w-2/4">
				...
				<div className="text-base sm:text-lg text-dark mt-2">
					Welcome to <span className="italic">NativCodes</span>, the
					place where we play with{" "}
					<span className="italic">The Code</span> and build awesome
					apps.
				</div>
				<div className="text-base sm:text-lg text-dark mt-2">
					We are a team of tech enthusiasts who thrive on solving
					complex problems and transforming ideas into reality. Our
					expertise lies in developing native applications for iOS and
					Android platforms, as well as building responsive websites
					using cutting-edge technologies.
				</div>
				<div className="text-base sm:text-lg text-dark mt-2">
					At <span className="italic">NativCodes</span>, we are
					committed to staying on the forefront of emerging
					technologies and trends. We continuously research and
					experiment with new tools and techniques, allowing us to
					provide our apps with the most performant, scalable, and
