...
import {getAboutLargeScreenTimeline, getAboutLeftSmallScreenTimeline, getAboutRightSmallScreenTimeline} from '../../utils/timelines';
	...
	return (
		<section className="about-section flex lg:h-screen flex-col lg:flex-row">
			<div className="about-section-left bg-primary relative flex justify-center items-center h-screen w-full lg:w-2/4">
				...
				<svg viewBox="0 0 512 512" width="130" height="130" className="hidden z-10 lg:block absolute right-[-65px] top-[96px]">
					<clipPath id="hexagon">
					...
					<div className="flex flex-row items-center w-[300px] h-[150px] lg:w-[400px] lg:h-[200px]">
						<div className="relative w-1/2 h-full">
							<div className="absolute css-tech-stack w-full h-full">
								<Image src="/assets/images/tech/css-logo.png" alt="css logo" layout="fill" />
							</div>
							<div className="absolute html-tech-stack w-full h-full">
								<Image src="/assets/images/tech/html-logo.png" alt="html logo" layout="fill" />
							</div>
						</div>

						<div className="relative w-1/2 h-full">
							<div className="absolute react-tech-stack w-full h-full">
								<Image src="/assets/images/tech/react-logo.png" alt="react logo" layout="fill" />
							</div>
							<div className="absolute javascript-tech-stack w-full h-full">
								<Image src="/assets/images/tech/javascript-logo.png" alt="javascript logo" layout="fill" />
							</div>
						</div>
					</div>
					...
					<div className="flex flex-row items-center w-[300px] h-[150px] lg:w-[400px] lg:h-[200px]">
						<div className="relative w-1/2 h-full">
							<div className="absolute php-tech-stack w-full h-full">
								<Image src="/assets/images/tech/php-logo.png" alt="php logo" layout="fill" />
							</div>
							<div className="absolute nodejs-tech-stack w-full h-full">
								<Image src="/assets/images/tech/nodejs-logo.png" alt="nodejs logo" layout="fill" />
							</div>
						</div>

						<div className="relative w-1/2 h-full">
							<div className="absolute mysql-tech-stack w-full h-full">
								<Image src="/assets/images/tech/mysql-logo.png" alt="mysql logo" layout="fill" />
							</div>
							<div className="absolute mongodb-tech-stack w-full h-full">
								<Image src="/assets/images/tech/mongodb-logo.png" alt="mongodb logo" layout="fill" />
							</div>
						</div>
					</div>
				</div>
