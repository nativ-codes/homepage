...
function Xido() {
  return (
    <section className="flex w-full flex-col sm:flex-row">
      ...
      <div className="hidden sm:block absolute left-[calc(25%-65px)] top-[96px] z-[9999] pointer-events-none">
      ...
      <div className="about-section-right relative bg-white p-[56px] sm:p-[96px] min-h-screen w-full sm:ml-[25%] sm:w-3/4 overflow-y-auto">
